...
// #define ETHERCAD_DEBUG

#ifdef ETHERCAD_DEBUG
  #define ETHERCAD_DEBUG_BEGIN_FUNCTION(x) {Serial.print("begin ");Serial.println(x);}
  #define ETHERCAD_DEBUG_END_FUNCTION(x) {Serial.print("end ");Serial.println(x);}
#else
  #define ETHERCAD_DEBUG_BEGIN_FUNCTION(x)
  #define ETHERCAD_DEBUG_END_FUNCTION(x)
#endif
